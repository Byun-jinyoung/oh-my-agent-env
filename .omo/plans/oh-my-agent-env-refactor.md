# oh-my-agent-env-refactor - Work Plan
...
- Evidence: .omo/evidence/task-<N>-oh-my-agent-env-refactor.<ext>
...
- [ ] 1. <title>
  ...
  QA scenarios (name the exact tool + invocation): happy + failure, Evidence .omo/evidence/task-1-oh-my-agent-env-refactor.<ext>
